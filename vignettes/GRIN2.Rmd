...
# Specify a directory on your local machine to store the analysis results:
# knitr::opts_knit$set(root.dir = normalizePath("folder path/test/"))
...
# First get a group of 25,000 regulatory features for an example run: 
hg19.reg.example=hg19.reg.annotation[c(30000:35000, 75000:80000, 
                                       140000:145000, 250000:255000,
                                       395000:400000),]
...
# First get a group of 25,000 FANTOM5 regulatory features for an example run:
hg19.FANTOM.example=hg19.reg.FANTOM[c(30000:35000, 75000:80000, 
                                       140000:145000, 230000:235000,
                                       395000:400000),]
...
# chrom.lsn.plot function can be used to generate a plot for all lesions of a specific lesion type that affect a locus or region of interest without adding transcripts track. This will allow plotting a larger locus of the chromosome such as a chromosome band.

chrom.lsn.plot(grin.results, 
               genome="hg19",
               hg19.cytoband=hg19_cytoband,
               chrom=9,
               plot.start=19900000,
...
# chrom.lsn.plot function can be also used to generate a plot for all types of lesions that affect a chromosome of interest with plot.start=1 and plot.end is the chr size:
chrom.lsn.plot(grin.results,
               genome="hg19",
               hg19.cytoband=hg19_cytoband,
               chrom=9,
...
# write KW test results:
write.csv(alex.kw.results, "alex.kw.results.csv")
```
...
```{r, message=FALSE, warning=FALSE}
# First open a PDF file to add boxplots, one gene per page
pdf("KW-q1e-15-boxplots.pdf", width = 8,height = 5, onefile = TRUE) 
# add boxplots based on a specified KW.q test results:
alex.boxplots(alex.data,
              alex.kw.results,
              1e-15,
              hg19.gene.annotation)
dev.off()
...
# top.alex.waterfall.plots("folder path/test/waterfall_plots/", 
#                          alex.data,
#                          alex.kw.results,
#                          1e-15,
#                          lesion.data)
...
write.csv(assc.outcomes, "associate.lsn.outcomes.csv")
...
write.csv(assc.outcomes.adj, "associate.lsn.outcomes.adj.csv")
