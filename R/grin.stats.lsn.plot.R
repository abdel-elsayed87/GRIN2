...
#'
#' # Retrieve gene and regulatory features annotation data from Ensembl BioMart:
#' hg19.ann=get.ensembl.annotation("Human_GRCh37")
#' # Human_GRCh38 can be used instead of Human_GRCh37 for hg38
#' # get regulatory features annotation data from Ensembl regulatory build:
#' hg19.reg.annotation=hg19.ann$reg.annotation.predicted
#' # get regulatory features annotation data from FANTOM5 project:
#' hg19.reg.FANTOM=hg19.ann$reg.annotation.validated
#'
#' # Run GRIN for computationally predicted regulatory features from Ensembl regulatory build:
#' grin.results.reg=grin.stats(lesion.data,
#'                             hg19.reg.annotation,
#'                             hg19.chrom.size)
#'
#' # Plots showing different types of lesions affecting regulatory feature of interest:
#' reg.plot=grin.stats.lsn.plot(grin.results.reg, feature="ENSR00002029697")
#'
#' # For experimentally verified regulatory features from FANTOM5 project:
#' grin.results.FANTOM=grin.stats(lesion.data,
#'                                hg19.reg.FANTOM5,
#'                                hg19.chrom.size)
#'
#' # Plots showing different types of lesions affecting regulatory feature from FANTOM5 Project:
#' reg.FANTOM=grin.stats.lsn.plot(grin.results.FANTOM, feature="p6@NRAS,0.2452")
#' }
