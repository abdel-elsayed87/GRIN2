...
#'
#' # return waterfall plots for a list of top significant genes to the specified folder:
#' top.genes.waterfall=top.alex.waterfall.plots("Path to the folder/waterfall.top.genes/",
#'                                              alex.data, alex.kw.results, 0.0000001, lesion.data)
#' }
...

{
  ...
  {
    grDevices::pdf(paste0(out.dir,top.genes[i],".pdf"),
        height=8,width=10)
