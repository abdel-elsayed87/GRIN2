...
#'
#' @description
#' Function prepare a plot with all types of lesions that spans either a gene or a small region of interest.
#'
...
#'
#' # for GRCh38 (hg38) genome assembly:
#' ah <- AnnotationHub()
...
#' # specifying genome version will directly retreive gene annotation and chrome size data
#'
#' # Plots showing different types of lesions affecting a gene of interest with a transcripts
#' # track that show all the gene transcripts retrieved from Ensembl (hg38 genome assembly):
#' lsn.transcripts.plot(grin.results, genome="hg38",  gene="WT1", hg38.transcripts=gtf.V110,
#'                        hg38.cytoband=hg38_cytoband)
#'
#' # Plots showing different types of lesions affecting a region of interest with a transcripts
#' # track added to the plot:
#' lsn.transcripts.plot(grin.results, genome="hg38", hg38.transcripts="gtf.v110",
#'                      hg38.cytoband=hg38_cytoband, chrom=9, plot.start=21800000,
#'                      plot.end=22200000, lesion.grp = "loss", spec.lsn.clr = "blue")
#' }
