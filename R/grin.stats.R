...
#' # for the GRCH37 (hg19) genome assembly:
#' grin.results=grin.stats(lesion.data, genome.version="Human_GRCh37")
#' # for the GRCH38 (hg38) genome assembly:
#' grin.results=grin.stats(lesion.data, genome.version="Human_GRCh38")
#' }
