...
#' # users can replace Human_GRCh37 with Human_GRCh38 for hg38 genome assembly
#'
#' # Write GRIN results using write.grin.xlsx function:
#' results.xlsx=write.grin.xlsx(grin.results, "T-ALL-GRIN-result.xlsx")
#' }
