...
#'
#' # To extract deletions from the lesion data file
#' loss=lesion.data[lesion.data$lsn.type=="loss",]
#' # To return lesion boundaries for deletions:
...
#'
#' # same analysis can be done for mutations and structural rearrangments.
#' }
