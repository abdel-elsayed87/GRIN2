...
#'
#' @seealso [useEnsembl()], [getBM()]
#'
#' @examples
#' \dontrun{
#' # Retreive annotation data for human hg19 genome assembly:
...
#'
#' # Retreive annotation data for human hg38 genome assembly:
...
#' # regulatory features annotation data retrieved from FANTOM5 project:
#' hg38.fantom.annotation=hg38.ann$reg.annotation.validated
#' }
