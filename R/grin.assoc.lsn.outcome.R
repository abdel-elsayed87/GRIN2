...
#' \itemize{
#'   \item \strong{Logistic regression} for binary outcomes (e.g., MRD), producing odds ratios (OR), 95\% confidence intervals (CI), p-values, and FDR-adjusted q-values.
...
#' \itemize{
#'   \item Odds ratio (OR), lower and upper 95\% CI, p-value, and q-value (FDR) for logistic regression models.
#'   \item Hazard ratio (HR), lower and upper 95\% CI, p-value, and q-value for Cox proportional hazards models.
